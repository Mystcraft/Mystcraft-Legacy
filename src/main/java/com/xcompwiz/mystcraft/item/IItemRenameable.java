...
/**
 * This interface allows you to create your own items which the Mystcraft writing desk can rename. Have your items
 * implement it to allow them to be renameable in the desk.
 * 
 * @author xcompwiz
 */
public interface IItemRenameable {
	...
	/**
	 * Retrieves the display name for the item. This is the text that appears in the text box. Note that this is
