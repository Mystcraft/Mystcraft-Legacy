...
/**
 * This interface allows you to create your own items which the Mystcraft writing desk can write to. Have your items
 * implement it to allow them to be writable in the desk.
 * 
 * @author xcompwiz
 */
