...
public interface IItemFactory {
	...
	/**
	 * Returns a page with the given symbol on it. Note, this succeeds even if the symbol is not a properly registered
	 * symbol
	 * 
	...
	/**
	 * Builds a link panel page with the specified properties Note, no filtering is applied to the link properties
	 * listed
	 * 
	...
	/**
	 * Builds a notebook containing pages for all of the symbols produced directly from the provided grammar tokens. The
	 * symbols come pre-sorted by Alphabetical order and will occur only once. Keep in mind localization limitations on
	 * the server, if you are creating this notebook there.
	 * 
	...
	/**
	 * Builds a notebook containing the provided pages. This clones the itemstacks of the pages. This will only add
	 * items which can be put into notebooks
	 * 
	 * @param name The name of the notebook
