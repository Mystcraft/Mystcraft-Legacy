...
public class MerchantRecipeProviderBooster implements IMerchantRecipeProvider {
	...
	public MerchantRecipeProviderBooster(int common, int uncommon, int rare) {
		this.common = common;
	...
	public List<MerchantRecipe> createNewMerchantRecipes(EntityVillager villager, Random random) {
		...
		for (int i = 0; i < 100; ++i) {
			ItemStack notebook = TreasureGenBooster.generateBooster(random, common, uncommon, rare);
