...
/**
 * Allows the setting of various treasure rarity and weighting values for symbols See {@link IGrammarAPI} for setting
 * the grammar rule(s) for a symbol These should be set before post-init The implementation of this is provided by
...
public interface ISymbolValuesAPI {
	...
	/**
	 * Can be used to prevent symbols from being tradeable By default, a symbol can be traded by a villager
	 * 
	...
	/**
	 * Can be used to set the items a villager will trade the symbol for. This version allows the setting of multiple
	 * trade items. Both items will be required for the trade.
	 * 
	 * @param symbol The symbol the villager will trade
