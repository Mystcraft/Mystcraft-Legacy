 ...
 * Look at the {@link IItemFactory} for methods for building page items Do NOT implement this yourself!
 * 
 * @author xcompwiz
 */
public interface IPageAPI {
	 ...
	 * 
	 * @param page The page to query
	 * @return Null is not a linking panel, otherwise a list of all the link properties on the panel. The list may be
	 *         empty.
	 */
