...
public interface IAgeSymbol {
	...
	/**
	 * How much instability should be added to the world. This is called every time the symbol is added to the world (if
	 * it is stacked). It is not necessary to use this function to add instability for duplicated critical logic. Used
	 * to limit stacking (ex. After three crystal symbols, add 100 instability every time crystal is added).
	 * 
	...
	/**
	 * Returns a list of words that are used to render the symbol Should return 4 words to build a Narayan "poem" See
	 * {@link WordData}
	 * 
