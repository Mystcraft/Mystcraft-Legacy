...
public class TriggerEnterMystDimensionQuinn implements ICriterionTrigger<TriggerEnterMystDimensionQuinn.Instance> {

	public static ResourceLocation ID = new ResourceLocation(MystObjects.MystcraftModId, "enter_myst_dimension_quinn");
