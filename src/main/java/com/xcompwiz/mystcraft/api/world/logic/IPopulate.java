...
public interface IPopulate {
	...
	/**
	 * This is called to perform generation on the chunk when the chunk first loads. The coordinates supplied are the world coordinates of the chunk (so
	 * chunkcoords * 16) as this is what vanilla populators use. This is called after biome decoration logic.
