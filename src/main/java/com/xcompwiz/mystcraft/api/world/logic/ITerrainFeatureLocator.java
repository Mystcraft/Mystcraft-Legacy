...
public interface ITerrainFeatureLocator {
	...
	/**
	 * Returns the location of the nearest instance of the named location. Can return null if there aren't any instances
	 * or if the named location is unrecognized You only need one of these if you are adding a structure you want to be
	 * able to locate using an item, akin to how Strongholds may be found
	 * 
