...
public interface AgeDirector {
	...
	/**
	 * Returns the sea level of the age. This is subject to change until all the symbols in the age are initialized.
	 */
	...
	/**
	 * Registers a new {@link IBiomeController} interface Each age wants exactly one of these
	 */
	public void registerInterface(IBiomeController controller);

	/**
	 * Registers a new {@link ITerrainGenerator} interface Each age wants exactly one of these
	 */
	public void registerInterface(ITerrainGenerator terrainGen);

	/**
	 * Registers a new {@link ILightingController} interface Each age wants exactly one of these
	 */
	public void registerInterface(ILightingController reg);

	/**
	 * Registers a new {@link IWeatherController} interface Each age wants exactly one of these
	 */
	...
	/**
	 * Registers a new {@link IChunkProviderFinalization} interface Any number of these may be registered
	 */
	public void registerInterface(IChunkProviderFinalization reg);

	/**
	 * Registers a new {@link IPopulate} interface Any number of these may be registered
	 */
	public void registerInterface(IPopulate reg);

	/**
	 * Registers a new {@link ITerrainFeatureLocator} interface Any number of these may be registered
	 */
	public void registerInterface(ITerrainFeatureLocator reg);

	/**
	 * Registers a new {@link ISpawnModifier} interface Any number of these may be registered
	 */
