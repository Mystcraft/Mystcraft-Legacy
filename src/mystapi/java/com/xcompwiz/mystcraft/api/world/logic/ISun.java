...
public interface ISun {
	 ...
	 * determine how bright the world should be.
	 * @return The normalized period position of the object
	 */
	public abstract float getCelestialPeriod(long time, float partialTime);

	/**
	 * Returns the number of ticks until this solar object is at 0.75 (celestial period position). Can return null if the sun never rises or if the rising time
	 * is unknown.
