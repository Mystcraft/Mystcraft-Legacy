...
/**
 * Thrown in the case of an API version having been removed entirely and no longer supported.
 * This can be interpreted as the request being for below the minimum supported version for the API.
 * @author xcompwiz
 */
